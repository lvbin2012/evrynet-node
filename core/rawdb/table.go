...
// database.
func (t *table) AppendAncient(number uint64, hash, header, body, receipts, td []byte, isFinalChain bool) error {
	return t.db.AppendAncient(number, hash, header, body, receipts, td, isFinalChain)
}
